...
export const SHIELD_TIERS: readonly PricingTierDef[] = [
  ...
  },
  {
    name: 'Enterprise',
    monthlyPrice: null,
    audience: 'For organisations with custom security, compliance, and scale requirements.',
    features: [
...
export const COMPARISON_FEATURES: readonly ComparisonFeature[] = [
  ...
  { name: 'Content review', free: 'no', pro: 'no', business: 'no', enterprise: 'yes' },
  { name: 'Compliance audit export', free: 'no', pro: 'no', business: 'no', enterprise: 'yes' },
  { name: 'Custom data retention', free: 'no', pro: 'no', business: 'no', enterprise: 'yes' },
  { name: 'Unlimited team seats', free: 'no', pro: 'no', business: 'no', enterprise: 'yes' },
  { name: 'Priority support', free: 'no', pro: 'no', business: 'no', enterprise: 'yes' },
]
