...
| ------------ | ---------- | ----------- | ------------------------------------------------------------------------------------- |
| `agent`      | `string`   | _required_  | The name of the agent requesting access. Displayed on the consent screen.             |
| `scopes`     | `string[]` | _required_  | Permission strings the agent is requesting. Format: `"permission:service"`.           |
