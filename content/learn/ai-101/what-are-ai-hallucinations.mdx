...
To understand hallucinations, it helps to remember how AI models work. As we covered in [What is Generative AI?](/learn/course-1/what-is-generative-ai), large language models generate text by predicting the next word in a sequence. They are pattern-matching engines, not fact databases.
...
You cannot eliminate hallucinations entirely, but you can significantly reduce them by changing how you ask questions. These techniques build on what we covered in [What Are Prompts and How Do They Work?](/learn/course-1/what-are-prompts).
