...
Over the past few articles, we have covered the ways agents can go wrong: [sending the wrong email](/learn/course-1/what-happens-when-an-ai-agent-makes-a-mistake), exceeding [spending limits](/learn/course-1/how-to-set-a-spending-limit-for-an-ai-agent), and acting without a proper [audit trail](/learn/course-1/what-is-an-audit-trail). In each case, the root cause was the same: the agent was deployed without sufficient evaluation of what it could do and what controls were in place.
...
- Can I reduce the permission set? (See [What Permissions Does Your AI Agent Actually Need?](/learn/course-1/what-permissions-does-your-ai-agent-need))
...
- Is your data used to train or improve the agent's underlying model? (See [Is My Data Safe with AI Tools?](/learn/course-1/is-my-data-safe-with-ai-tools))
