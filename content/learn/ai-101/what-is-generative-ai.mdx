...
ogImage: '/learn/og-what-is-generative-ai.png'
...
- **It cannot take actions on its own.** A plain LLM can only generate text. It cannot send an email, book a meeting, or make a purchase — unless it is connected to external tools. (More on this in our article on [AI agents](/learn/ai-101/what-are-ai-agents-and-permissions).)
...
- **Use AI tools more effectively.** Knowing how an LLM works helps you write better requests (called "prompts") and get better results. Our next article covers [how prompts work](/learn/ai-101/what-are-prompts).
...
**Next up:** [What Are Prompts and How Do They Work?](/learn/ai-101/what-are-prompts)
