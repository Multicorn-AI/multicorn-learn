...
An AI agent operates differently. As we discussed in [What Is an AI Agent?](/learn/course-1/what-is-an-ai-agent), agents take real-world actions: they connect to services and make things happen. When an agent hallucinates or misinterprets an instruction, the consequences are not just text on a screen. They are real events that may be difficult or impossible to reverse.
