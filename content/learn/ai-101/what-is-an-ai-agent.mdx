...
When you use a chatbot, the worst thing that can happen is that you get a wrong answer (a [hallucination](/learn/course-1/what-are-ai-hallucinations)). You read the response, notice the error, and move on. Nothing in the real world changed.
...
The next article looks at [what AI agents can actually do today](/learn/course-1/what-can-ai-agents-do-today) with concrete, real-world examples.
