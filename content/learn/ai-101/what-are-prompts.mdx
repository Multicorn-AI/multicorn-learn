...
The AI reads your prompt, processes it using the patterns it learned during training (covered in our [previous article](/learn/course-1/what-is-generative-ai)), and generates a response based on what it predicts would be the most helpful continuation.
...
Our next article covers [what AI agents are and why they need permissions](/learn/course-1/what-are-ai-agents-and-permissions), and how tools like Multicorn Shield help you stay in control.
