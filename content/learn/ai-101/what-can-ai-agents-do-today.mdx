...
As we covered in [What Is an AI Agent and How Is It Different from a Chatbot?](/learn/course-1/what-is-an-ai-agent), an agent is software that can take real-world actions, not just generate text. It connects to external services, breaks down goals into steps, and executes those steps with varying degrees of independence.
