...
It also means the developer community can contribute. Shield supports the [Model Context Protocol](/learn/ai-101/what-is-the-model-context-protocol) out of the box, and we want to add adapters for every major agent framework. That is easier to do with contributions from people who actually use those frameworks every day.
...
**Previous:** [AI Agents for Small Teams: A Practical Guide](/learn/ai-101/ai-agents-for-small-teams)
