...
ogImage: '/learn/og-what-are-tokens-and-why-do-they-matter.png'
...
**Longer responses cost more.** If you ask for a detailed, comprehensive answer, the AI generates more output tokens, which increases the cost.
...
For AI agents (covered in [What Is an AI Agent?](/learn/ai-101/what-is-an-ai-agent) and [What Can AI Agents Actually Do Today?](/learn/ai-101/what-can-ai-agents-do-today)), tokens matter even more.
...
**Next up:** [Is My Data Safe with AI Tools?](/learn/ai-101/is-my-data-safe-with-ai-tools)
