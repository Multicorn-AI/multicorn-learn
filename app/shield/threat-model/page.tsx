          ...
          <div className="mx-auto max-w-3xl">
            ...
            <div className="mt-8 grid gap-8 sm:grid-cols-2">
              ...
              <div className="rounded-card border border-border bg-surface p-6">
                ...
                <p className="mt-3 text-sm leading-relaxed text-text-secondary">
                  This is the right mental model for Cursor, Kilo Code, GitHub Copilot, Continue,
                  Goose, and other clients you connect through the proxy. Windsurf also supports
                  hosted proxy mode alongside its native plugin. You get strong governance for MCP
                  tools. You do not get visibility into built-in host capabilities that never pass
                  through MCP.
                </p>
              </div>
            </div>
