...
export const metadata: Metadata = {
  title: 'Cursor Track | Multicorn Learn',
  description: 'Vibe coding lessons for Cursor. Content coming soon.',
  openGraph: {
    title: 'Cursor Track | Multicorn Learn',
    description: 'Vibe coding lessons for Cursor. Content coming soon.',
    type: 'website',
...
export default function Course2CursorPage() {
  if (!isCourse2Enabled()) {
    redirect('/learn')
  }
  ...
  return (
    <main className="flex min-h-screen flex-col items-center px-6 pb-20 pt-16 sm:pb-28 sm:pt-24">
      <div className="w-full max-w-content">
        ...
        <h1 className="text-3xl font-bold tracking-tight text-text-primary sm:text-4xl">Cursor</h1>
