...
import { CURSOR_TRACK_BASE_PATH } from '@/lib/cursor-track-config'
...
const COURSE_ID = `${SITE_URL}${CURSOR_TRACK_BASE_PATH}#course`
...
export async function generateMetadata({ params }: CursorLessonPageProps): Promise<Metadata> {
  ...
  const lesson = getCursorLesson(slug)
  ...
  return {
    ...
    openGraph: {
      ...
      url: `${SITE_URL}${CURSOR_TRACK_BASE_PATH}/${lesson.slug}`,
    },
    twitter: {
    ...
    '@graph': [
      {
        ...
        hasCourseInstance: {
          '@type': 'CourseInstance',
          courseMode: 'online',
          url: `${SITE_URL}${CURSOR_TRACK_BASE_PATH}`,
        },
      },
      {
        ...
        <div className="mx-auto max-w-content">
          <div className="lg:grid lg:grid-cols-[1fr_250px] lg:gap-12">
            <article className="mx-auto max-w-3xl lg:mx-0">
              ...
              <LessonCompleteButton slug={slug} />

              <LessonNavigation basePath={CURSOR_TRACK_BASE_PATH} navigation={navigation} />
            </article>
