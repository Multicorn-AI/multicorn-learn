...
const trackConfig = getTrackConfig('claude-code')
...
export default function Course2ClaudeCodeHubPage() {
  if (!isCourse2Enabled()) {
    redirect('/learn')
  }
    ...
    <main className="flex min-h-screen flex-col items-center px-6 pb-20 pt-16 sm:pb-28 sm:pt-24">
      <div className="w-full max-w-content">
        ...
        <div className="mb-12 flex flex-col gap-4 sm:flex-row sm:items-start sm:gap-6">
          <div
            className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-indigo/10 text-indigo"
            aria-hidden="true"
          >
        ...
        <section aria-labelledby="claude-code-lessons-heading">
          <h2
            id="claude-code-lessons-heading"
