...
export const metadata: Metadata = {
  title: 'Course 4: AutoHive | Multicorn Learn',
  description: 'AutoHive track for Course 4. Step-by-step lessons are coming soon.',
  openGraph: {
    title: 'Course 4: AutoHive | Multicorn Learn',
    description: 'AutoHive track for Course 4. Content coming soon.',
    type: 'website',
  },
}
