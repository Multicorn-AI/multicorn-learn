...
const copy = course4PlatformStubCopy.autohive
const trackConfig = getCourse4TrackConfig('autohive')
...
export default function Course4AutohivePage() {
  if (!isCourse4Enabled()) {
    redirect('/learn')
  }

  const lessons = getAllCourse4Lessons('autohive')
  ...
  return (
    <main className="flex min-h-screen flex-col items-center px-6 pb-20 pt-16 sm:pb-28 sm:pt-24">
      <div className="w-full max-w-content">
        ...
        <Course4PlatformStubArticle platformKey="autohive" />

        <div className="mx-auto mt-16 max-w-3xl px-4">
          <section aria-labelledby="autohive-lessons-heading">
            <h2
              id="autohive-lessons-heading"
