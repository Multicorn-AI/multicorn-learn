...
import { course4AutohiveComponents } from '@/lib/mdx-course2-components'
...
export default async function Course4AutohiveLessonPage({ params }: LessonPageProps) {
  if (!isCourse4Enabled()) {
    redirect('/learn')
  }
            ...
            <article className="mx-auto max-w-3xl lg:mx-0">
              ...
              <div className="prose-multicorn">
                <MDXRemote
                  ...
                  components={course4AutohiveComponents}
