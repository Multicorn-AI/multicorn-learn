...
const trackConfig = getCourse4TrackConfig('mindstudio')
...
export default function Course4MindstudioPage() {
  ...
  const lessons = getAllCourse4Lessons('mindstudio')
    ...
    <main className="flex min-h-screen flex-col items-center px-6 pb-20 pt-16 sm:pb-28 sm:pt-24">
      <div className="w-full max-w-content">
        ...
        <div className="mx-auto mt-16 max-w-3xl px-4">
          <section aria-labelledby="mindstudio-lessons-heading">
            <h2
              id="mindstudio-lessons-heading"
