...
export const metadata: Metadata = {
  title: 'Course 4: n8n | Multicorn Learn',
  description: 'n8n track for Course 4. Step-by-step lessons are coming soon.',
  openGraph: {
    title: 'Course 4: n8n | Multicorn Learn',
    description: 'n8n track for Course 4. Content coming soon.',
    type: 'website',
  },
}

export default function Course4N8nPage() {
  if (!isCourse4Enabled()) {
    redirect('/learn')
  }
  ...
  return (
    <main className="flex min-h-screen flex-col items-center px-6 pb-20 pt-16 sm:pb-28 sm:pt-24">
      <div className="w-full max-w-content">
        ...
        <h1 className="text-3xl font-bold tracking-tight text-text-primary sm:text-4xl">n8n</h1>
