...
const copy = course4PlatformStubCopy.n8n
const trackConfig = getCourse4TrackConfig('n8n')
...
export default function Course4N8nPage() {
  ...
  const lessons = getAllCourse4Lessons('n8n')
  ...
  return (
    <main className="flex min-h-screen flex-col items-center px-6 pb-20 pt-16 sm:pb-28 sm:pt-24">
      <div className="w-full max-w-content">
        ...
        <Course4PlatformStubArticle platformKey="n8n" />

        <div className="mx-auto mt-16 max-w-3xl px-4">
          <section aria-labelledby="n8n-lessons-heading">
            <h2
              id="n8n-lessons-heading"
