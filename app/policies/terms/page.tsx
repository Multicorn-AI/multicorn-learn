        ...
        <div className="w-full max-w-3xl">
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-base leading-relaxed text-text-secondary">
              <p>
                We are Multicorn AI Pty Ltd, doing business as Multicorn AI (&quot;Company,&quot;
              ...
              <p>
                Multicorn is a platform providing AI agent permission controls (Shield) and AI
                education resources (Learn).
              </p>
              <p>
              ...
              <p>
                ...
                personally or on behalf of an entity (&quot;you&quot;), and Multicorn AI Pty Ltd,
          ...
          <section className="mb-12">
            ...
            <nav>
              <ol className="list-decimal space-y-1 pl-6 text-base text-primary">
                ...
                <li>
                  <a href="#intellectual-property-rights" className="hover:underline">
                    INTELLECTUAL PROPERTY RIGHTS
                  </a>
                </li>
                <li>
                  <a href="#user-representations" className="hover:underline">
                    USER REPRESENTATIONS
                  </a>
                </li>
                <li>
                  <a href="#user-registration" className="hover:underline">
                    USER REGISTRATION
                  </a>
                </li>
                <li>
                  <a href="#purchases-and-payment" className="hover:underline">
                ...
                <li>
                  <a href="#prohibited-activities" className="hover:underline">
                    PROHIBITED ACTIVITIES
                  </a>
                </li>
                <li>
                  <a href="#user-generated-contributions" className="hover:underline">
                    USER GENERATED CONTRIBUTIONS
                  </a>
                </li>
                <li>
                  <a href="#contribution-license" className="hover:underline">
                    CONTRIBUTION LICENSE
                  </a>
                </li>
                <li>
                  <a href="#third-party-websites-and-content" className="hover:underline">
                    THIRD-PARTY WEBSITES AND CONTENT
                  </a>
                </li>
                <li>
                  <a href="#services-management" className="hover:underline">
                    SERVICES MANAGEMENT
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="#term-and-termination" className="hover:underline">
                    TERM AND TERMINATION
                  </a>
                </li>
                <li>
                  <a href="#modifications-and-interruptions" className="hover:underline">
                ...
                <li>
                  <a href="#limitations-of-liability" className="hover:underline">
                ...
                <li>
                  <a href="#user-data" className="hover:underline">
                    USER DATA
                  </a>
                </li>
                <li>
                  <a href="#electronic-communications" className="hover:underline">
                    ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES
                  </a>
                </li>
                <li>
                  <a href="#california-users-and-residents" className="hover:underline">
          ...
          <section id="our-services" className="mb-12 scroll-mt-24">
            <h2 className="mb-4 text-2xl font-bold text-text-primary">1. Our services</h2>
            <div className="space-y-4 text-base leading-relaxed text-text-secondary">
              <p>
          ...
          <section id="intellectual-property-rights" className="mb-12 scroll-mt-24">
            <h2 className="mb-4 text-2xl font-bold text-text-primary">
              2. Intellectual property rights
            </h2>
            ...
            <h3 className="mb-3 mt-6 text-lg font-semibold text-text-primary">Your submissions</h3>
            <div className="space-y-4 text-base leading-relaxed text-text-secondary">
              <p>
                ...
                you give us and (b) obligations you have when you post or upload any content through
                the Services.
              </p>
              <p>
                <strong className="text-text-primary">Submissions:</strong> By directly sending us
                any question, comment, suggestion, idea, feedback, or other information about the
                Services (&quot;Submissions&quot;), you agree to assign to us all intellectual
                property rights in such Submission. You agree that we shall own this Submission and
                be entitled to its unrestricted use and dissemination for any lawful purpose,
          ...
          <section id="user-representations" className="mb-12 scroll-mt-24">
            <h2 className="mb-4 text-2xl font-bold text-text-primary">3. User representations</h2>
            <div className="space-y-4 text-base leading-relaxed text-text-secondary">
              <p>
                ...
                reside; (5) you will not access the Services through automated or non-human means,
                whether through a bot, script or otherwise; (6) you will not use the Services for
          ...
          {/* ── 4. USER REGISTRATION ── */}
          <section id="user-registration" className="mb-12 scroll-mt-24">
            <h2 className="mb-4 text-2xl font-bold text-text-primary">4. User registration</h2>
            <div className="space-y-4 text-base leading-relaxed text-text-secondary">
              <p>
          ...
          <section id="purchases-and-payment" className="mb-12 scroll-mt-24">
            <h2 className="mb-4 text-2xl font-bold text-text-primary">5. Purchases and payment</h2>
            <div className="space-y-4 text-base leading-relaxed text-text-secondary">
          ...
          <section id="subscriptions" className="mb-12 scroll-mt-24">
            <h2 className="mb-4 text-2xl font-bold text-text-primary">6. Subscriptions</h2>
            ...
            <div className="space-y-4 text-base leading-relaxed text-text-secondary">
              <p>
                ...
                to our charging your payment method on a recurring basis without requiring your
            ...
            <h3 className="mb-3 mt-6 text-lg font-semibold text-text-primary">Cancellation</h3>
            <div className="space-y-4 text-base leading-relaxed text-text-secondary">
              <p>
            ...
            <h3 className="mb-3 mt-6 text-lg font-semibold text-text-primary">Fee Changes</h3>
            <div className="space-y-4 text-base leading-relaxed text-text-secondary">
              <p>
          ...
          <section id="prohibited-activities" className="mb-12 scroll-mt-24">
            <h2 className="mb-4 text-2xl font-bold text-text-primary">7. Prohibited activities</h2>
            <div className="space-y-4 text-base leading-relaxed text-text-secondary">
              <p>
          ...
          <section id="user-generated-contributions" className="mb-12 scroll-mt-24">
            <h2 className="mb-4 text-2xl font-bold text-text-primary">
              8. User generated contributions
            </h2>
            <div className="space-y-4 text-base leading-relaxed text-text-secondary">
              <p>
                ...
                Services and through third-party websites. As such, any Contributions you transmit
                may be treated in accordance with the Services&apos; Privacy Policy. When you create
              ...
              <ul className="list-disc space-y-2 pl-6">
                ...
                <li>
                  ...
                  releases, and permissions to use and to authorize us, the Services, and other
                  users of the Services to use your Contributions in any manner contemplated by the
          ...
          <section id="contribution-license" className="mb-12 scroll-mt-24">
            <h2 className="mb-4 text-2xl font-bold text-text-primary">9. Contribution license</h2>
            <div className="space-y-4 text-base leading-relaxed text-text-secondary">
              <p>
          ...
          <section id="third-party-websites-and-content" className="mb-12 scroll-mt-24">
            <h2 className="mb-4 text-2xl font-bold text-text-primary">
              10. Third-party websites and content
            </h2>
            <div className="space-y-4 text-base leading-relaxed text-text-secondary">
              <p>
                ...
                through the Services or any Third-Party Content posted on, available through, or
                installed from the Services, including the content, accuracy, offensiveness,
                ...
                the Services and access the Third-Party Websites or to use or install any
                Third-Party Content, you do so at your own risk, and you should be aware these Legal
                ...
                hold us blameless from any losses sustained by you or harm caused to you relating to
          ...
          <section id="services-management" className="mb-12 scroll-mt-24">
            <h2 className="mb-4 text-2xl font-bold text-text-primary">11. Services management</h2>
            <div className="space-y-4 text-base leading-relaxed text-text-secondary">
              <p>
          ...
          <section id="privacy-policy" className="mb-12 scroll-mt-24">
            <h2 className="mb-4 text-2xl font-bold text-text-primary">12. Privacy policy</h2>
            <div className="space-y-4 text-base leading-relaxed text-text-secondary">
              <p>
                We care about data privacy and security. Please review our Privacy Policy:{' '}
                <Link href="/policies/privacy" className="text-primary hover:underline">
                  https://multicorn.ai/policies/privacy
                </Link>
                ...
                Australia and United States. If you access the Services from any other region of the
                world with laws or other requirements governing personal data collection, use, or
                disclosure that differ from applicable laws in Australia and United States, then
                through your continued use of the Services, you are transferring your data to
                Australia and United States, and you expressly consent to have your data transferred
                to and processed in Australia and United States.
              </p>
            </div>
          </section>

          {/* ── 13. TERM AND TERMINATION ── */}
          <section id="term-and-termination" className="mb-12 scroll-mt-24">
            <h2 className="mb-4 text-2xl font-bold text-text-primary">13. Term and termination</h2>
            <div className="space-y-4 text-base leading-relaxed text-text-secondary">
              <p>
          ...
          <section id="modifications-and-interruptions" className="mb-12 scroll-mt-24">
            <h2 className="mb-4 text-2xl font-bold text-text-primary">
              14. Modifications and interruptions
            </h2>
            <div className="space-y-4 text-base leading-relaxed text-text-secondary">
          ...
          <section id="governing-law" className="mb-12 scroll-mt-24">
            <h2 className="mb-4 text-2xl font-bold text-text-primary">15. Governing law</h2>
            <div className="space-y-4 text-base leading-relaxed text-text-secondary">
              <p>
                These Legal Terms shall be governed by and defined following the laws of Australia.
                Multicorn AI Pty Ltd and yourself irrevocably consent that the courts of Australia
          ...
          <section id="dispute-resolution" className="mb-12 scroll-mt-24">
            <h2 className="mb-4 text-2xl font-bold text-text-primary">16. Dispute resolution</h2>
            ...
            <div className="space-y-4 text-base leading-relaxed text-text-secondary">
              <p>
                ...
                the Rules of this ICAC, which, as a result of referring to it, is considered as the
                part of this clause. The number of arbitrators shall be one (1). The seat, or legal
                place, or arbitration shall be Sydney, Australia. The language of the proceedings
                shall be English. The governing law of these Legal Terms shall be substantive law of
                Australia.
              </p>
            </div>

            <h3 className="mb-3 mt-6 text-lg font-semibold text-text-primary">Restrictions</h3>
            <div className="space-y-4 text-base leading-relaxed text-text-secondary">
              <p>
          ...
          <section id="corrections" className="mb-12 scroll-mt-24">
            <h2 className="mb-4 text-2xl font-bold text-text-primary">17. Corrections</h2>
            <div className="space-y-4 text-base leading-relaxed text-text-secondary">
              <p>
          ...
          <section id="disclaimer" className="mb-12 scroll-mt-24">
            <h2 className="mb-4 text-2xl font-bold text-text-primary">18. Disclaimer</h2>
            <div className="space-y-4 text-base leading-relaxed text-text-secondary">
              <p>
                ...
                THE SERVICES, (3) ANY UNAUTHORIZED ACCESS TO OR USE OF OUR SECURE SERVERS AND/OR ANY
          ...
          <section id="limitations-of-liability" className="mb-12 scroll-mt-24">
            <h2 className="mb-4 text-2xl font-bold text-text-primary">
              19. Limitations of liability
            </h2>
            <div className="space-y-4 text-base leading-relaxed text-text-secondary">
          ...
          <section id="indemnification" className="mb-12 scroll-mt-24">
            <h2 className="mb-4 text-2xl font-bold text-text-primary">20. Indemnification</h2>
            <div className="space-y-4 text-base leading-relaxed text-text-secondary">
              <p>
          ...
          <section id="user-data" className="mb-12 scroll-mt-24">
            <h2 className="mb-4 text-2xl font-bold text-text-primary">21. User data</h2>
            <div className="space-y-4 text-base leading-relaxed text-text-secondary">
              <p>
          ...
          <section id="california-users-and-residents" className="mb-12 scroll-mt-24">
            <h2 className="mb-4 text-2xl font-bold text-text-primary">
              23. California users and residents
            </h2>
            <div className="space-y-4 text-base leading-relaxed text-text-secondary">
          ...
          <section id="miscellaneous" className="mb-12 scroll-mt-24">
            <h2 className="mb-4 text-2xl font-bold text-text-primary">24. Miscellaneous</h2>
            <div className="space-y-4 text-base leading-relaxed text-text-secondary">
              <p>
          ...
          <section id="contact-us" className="mb-12 scroll-mt-24">
            <h2 className="mb-4 text-2xl font-bold text-text-primary">25. Contact us</h2>
            <div className="space-y-4 text-base leading-relaxed text-text-secondary">
              <p>
