...
export function OtherPlatformsDisclosure({ children }: { readonly children: React.ReactNode }) {
  ...
  return (
    <details className="group mb-6 rounded-lg border border-border bg-surface-secondary [&>summary::-webkit-details-marker]:[display:none] [&>summary::marker]:[display:none] [&>summary]:list-none">
      <summary className="flex min-h-[44px] cursor-pointer list-none items-center gap-3 p-4 text-sm font-semibold leading-snug text-text-primary transition-colors hover:bg-course-3-accent/5 focus:outline-none focus-visible:ring-2 focus-visible:ring-course-3-accent/30 focus-visible:ring-offset-2 sm:p-5">
        <ChevronRight
