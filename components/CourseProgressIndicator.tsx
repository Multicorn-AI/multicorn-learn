...
const activePillClasses: Record<1 | 2 | 3 | 4, string> = {
  ...
  4: 'border-violet-500/30 bg-violet-500/10 text-violet-600 hover:border-violet-500/40 focus:ring-violet-500/20',
}
...
export function CourseProgressIndicator({ activeCourse }: CourseProgressIndicatorProps) {
  ...
  return (
    ...
    >
      ...
      <Connector />
      <PillLink label="Course 4" shortLabel="C4" state={c4} href={href4} courseNum={4} />
    </div>
  )
}
